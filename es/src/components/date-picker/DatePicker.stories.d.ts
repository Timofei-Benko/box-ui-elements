...
declare const _default: {
    title: string;
    component: React.ForwardRefExoticComponent<Pick<import("./DatePicker").DatePickerProps, "className" | "label" | "name" | "isDisabled" | "placeholder" | "onFocus" | "onBlur" | "onChange" | "description" | "hideLabel" | "value" | "error" | "customInput" | "dateFormat" | "displayFormat" | "errorTooltipPosition" | "hideOptionalLabel" | "inputProps" | "isAlwaysVisible" | "isClearable" | "isRequired" | "isKeyboardInputAllowed" | "isTextInputAllowed" | "maxDate" | "minDate" | "resinTarget" | "yearRange"> & {
