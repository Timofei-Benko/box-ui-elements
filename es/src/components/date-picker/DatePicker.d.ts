...
declare const _default: React.ForwardRefExoticComponent<Pick<DatePickerProps, "className" | "label" | "name" | "isDisabled" | "placeholder" | "onFocus" | "onBlur" | "onChange" | "description" | "hideLabel" | "value" | "error" | "customInput" | "dateFormat" | "displayFormat" | "errorTooltipPosition" | "hideOptionalLabel" | "inputProps" | "isAlwaysVisible" | "isClearable" | "isRequired" | "isKeyboardInputAllowed" | "isTextInputAllowed" | "maxDate" | "minDate" | "resinTarget" | "yearRange"> & {
