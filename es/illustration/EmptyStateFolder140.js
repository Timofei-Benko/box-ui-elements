...
var EmptyStateFolder140 = function EmptyStateFolder140(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    fill: vars.bdlBoxBlue10,
    d: "M51 96a7 7 0 110 14 7 7 0 010-14zm47-66c5.523 0 10 4.477 10 10s-4.477 10-10 10-10-4.477-10-10 4.477-10 10-10z"
  }), React.createElement("path", {
    fill: vars.white,
    fillRule: "nonzero",
    ...
    fill: vars.bdlBoxBlue10,
    fillRule: "nonzero",
    d: "M44.156 39c.466 0 .844.448.844 1s-.378 1-.844 1h-6.312c-.466 0-.844-.448-.844-1s.378-1 .844-1h6.312zm41.952 21c.493 0 .892.448.892 1s-.4 1-.892 1H61.892c-.493 0-.892-.448-.892-1s.4-1 .892-1h24.216z"
  }), React.createElement("path", {
    d: "M79 93.5h7"
  }), React.createElement("path", {
    ...
    fill: vars.white,
    fillRule: "nonzero",
    d: "M81.463 83.17a1.03 1.03 0 011.269.107l.09.095 4.932 5.898c.159.19.246.43.246.679 0 .542-.405.988-.925 1.045L86.96 91H85v4.92c0 .597-.496 1.081-1.11 1.081h-3.779c-.613 0-1.11-.484-1.11-1.08L79 91h-1.961c-.207 0-.408-.062-.578-.177l-.098-.076a1.06 1.06 0 01-.187-1.384l.074-.098 4.99-5.898.057-.061.061-.057.105-.08z"
  })));
};
