...
describe('features/unified-share-modal/utils/hasRestrictedExternalContacts', function () {
  var contacts = [{
    email: 'x@example.com',
    id: '12345',
    text: 'X User',
  ...
  test('should return false when no restricted external emails are found within contacts', function () {
  ...
  test('should return true when at least one restricted external email is found within contacts', function () {
    var restrictedExternalEmails;
