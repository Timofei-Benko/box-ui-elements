  ...
  _createClass(SharedLinkPermissionMenu, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          isSharedLinkEditTooltipShown = _this$props2.isSharedLinkEditTooltipShown,
      ...
      var canShowTag = sharedLinkEditTagTargetingApi ? sharedLinkEditTagTargetingApi.canShow : false;
      var canShowTooltip = sharedLinkEditTooltipTargetingApi ? sharedLinkEditTooltipTargetingApi.canShow : false;
      ...
      return React.createElement(DropdownMenu, {
        ...
        }, React.createElement("span", null, permissionLevels[level].label), level === CAN_EDIT && canShowTag && React.createElement(LabelPill.Pill, {
