...
export var columnForItemLastUpdated = {
...
export var columnWithMultiEnumType = {
  displayName: 'Offices',
  id: '5',
  isShown: true,
  property: 'offices',
...
export var columnWithFloatType = {
  displayName: 'Count',
  id: '6',
  isShown: true,
  property: 'count',
...
export var columnForTemplateFieldName = {
  displayName: 'Name',
  id: '7',
  isShown: true,
  property: 'name',
...
export var columnWithNumberType = {
  displayName: 'Assets',
  id: '8',
  isShown: true,
  property: 'assets',
...
var metadataColumns = [columnWithEnumType, columnWithMultiEnumType];
var expectedVisibleColumns = {
  visibleColumns: [{
    displayName: 'Size',
    id: 'item_27',
    key: 'size',
...
var expectedVisibleColumnsOneHidden = {
  visibleColumns: [{
    displayName: 'Size',
    id: 'item_27',
    key: 'size',
...
var metadataTableStateAfterMount = {
  visibleColumns: [{
    displayName: 'Size',
    id: 'item_27',
    key: 'size',
