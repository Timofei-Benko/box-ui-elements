  ...
  function Instance(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderEditButton", function () {
      ...
      if (canEdit && !isDirty && !isBusy) {
        var metadataLabelEditText = intl.formatMessage(messages.metadataEditTooltip);
  ...
  _createClass(Instance, [{
    ...
    value: function getTitle() {
      var _this$props7 = this.props,
          _this$props7$cascadeP = _this$props7.cascadePolicy,
          cascadePolicy = _this$props7$cascadeP === void 0 ? {} : _this$props7$cascadeP,
    ...
    value: function canEdit() {
      var _this$props9 = this.props,
          canEdit = _this$props9.canEdit,
          onModification = _this$props9.onModification,
    ...
    value: function render() {
      var _this$props10 = this.props,
          _this$props10$cascade = _this$props10.cascadePolicy,
          cascadePolicy = _this$props10$cascade === void 0 ? {} : _this$props10$cascade,
          isDirty = _this$props10.isDirty,
          isCascadingPolicyApplicable = _this$props10.isCascadingPolicyApplicable,
