...
var noFieldsForTemplate = [];
describe('features/metadata-instance-editor/fields/TemplatedInstance', function () {
  test('should correctly render fields that are visible', function () {
    var wrapper = shallow(React.createElement(TemplatedInstance, {
      data: data,
      dataValue: "value",
      errors: {},
      template: {
  ...
  test('should correctly render attributes hidden message', function () {
    var wrapper = shallow(React.createElement(TemplatedInstance, {
      data: data,
      dataValue: "value",
      errors: {},
  ...
  test('should correctly render no attributes message', function () {
    var wrapper = shallow(React.createElement(TemplatedInstance, {
      data: data,
      dataValue: "value",
      errors: {},
