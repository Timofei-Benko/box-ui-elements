...
var IconSecurityClassificationSolid = function IconSecurityClassificationSolid(_ref) {
  var _ref$className = _ref.className,
      className = _ref$className === void 0 ? '' : _ref$className,
      _ref$fillColor = _ref.fillColor,
      fillColor = _ref$fillColor === void 0 ? bdlGray20 : _ref$fillColor,
      _ref$height = _ref.height,
      height = _ref$height === void 0 ? 16 : _ref$height,
      title = _ref.title,
      _ref$width = _ref.width,
      width = _ref$width === void 0 ? 16 : _ref$width;
  var classes = classNames('bdl-IconSecurityClassificationSolid', className);
