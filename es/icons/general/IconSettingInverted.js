...
var IconSettingInverted = function IconSettingInverted(_ref) {
  ...
  return React.createElement(AccessibleSVG, {
    className: "icon-setting-inverted ".concat(className),
    height: height,
    title: title,
    viewBox: "0 0 16 16",
    width: width
