...
function (_React$Component) {
  ...
  function IconGoogleSlides() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(IconGoogleSlides)).call.apply(_getPrototypeOf2, [this].concat(args)));
