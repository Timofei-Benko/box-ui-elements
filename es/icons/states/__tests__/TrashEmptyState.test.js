...
describe('icons/states/TrashEmptyState', function () {
  test('should correctly render default svg', function () {
    var wrapper = shallow(React.createElement(TrashEmptyState, null));
  ...
  test('should correctly render svg with specified class', function () {
    ...
    var wrapper = shallow(React.createElement(TrashEmptyState, {
      className: className
    }));
