...
describe('icons/states/ErrorEmptyState', function () {
  test('should correctly render default icon', function () {
    var wrapper = shallow(React.createElement(ErrorEmptyState, null));
  ...
  test('should correctly render the icon with specified class', function () {
    ...
    var wrapper = shallow(React.createElement(ErrorEmptyState, {
      className: className
    }));
