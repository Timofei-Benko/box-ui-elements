...
describe('icons/states/MetadataEmptyState', function () {
  test('should correctly render default icon', function () {
    var wrapper = shallow(React.createElement(MetadataEmptyState, null));
  ...
  test('should correctly render the icon with specified class', function () {
    ...
    var wrapper = shallow(React.createElement(MetadataEmptyState, {
      className: className
    }));
