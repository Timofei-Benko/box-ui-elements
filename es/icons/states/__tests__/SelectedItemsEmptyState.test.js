...
describe('icons/states/SelectedItemsEmptyState', function () {
  test('should correctly render default icon', function () {
    var wrapper = shallow(React.createElement(SelectedItemsEmptyState, null));
  ...
  test('should correctly render the icon with specified class', function () {
    ...
    var wrapper = shallow(React.createElement(SelectedItemsEmptyState, {
      className: className
    }));
