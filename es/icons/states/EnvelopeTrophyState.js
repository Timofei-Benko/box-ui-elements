...
var ICON_CLASS = 'envelope-trophy-state';

var EnvelopeTrophyState =
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(EnvelopeTrophyState, _React$PureComponent);

  function EnvelopeTrophyState() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, EnvelopeTrophyState);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EnvelopeTrophyState)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(EnvelopeTrophyState, [{
    key: "render",
