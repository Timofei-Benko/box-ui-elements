...
var UploadFilePaywallState = function UploadFilePaywallState(_ref) {
  var _ref$className = _ref.className,
      className = _ref$className === void 0 ? '' : _ref$className,
      _ref$color = _ref.color,
      color = _ref$color === void 0 ? bdlBoxBlue : _ref$color,
      _ref$height = _ref.height,
      height = _ref$height === void 0 ? 129 : _ref$height,
      title = _ref.title,
      _ref$width = _ref.width,
      width = _ref$width === void 0 ? 133 : _ref$width;
  return React.createElement(AccessibleSVG, {
    className: "upload-file-paywall-state ".concat(className),
    height: height,
    title: title,
    viewBox: "0 0 133 129",
    width: width
