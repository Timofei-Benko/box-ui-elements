...
import { ERROR_CODE_CREATE_ANNOTATION, ERROR_CODE_DELETE_ANNOTATION, ERROR_CODE_EDIT_ANNOTATION, ERROR_CODE_FETCH_ANNOTATION, ERROR_CODE_FETCH_ANNOTATIONS } from '../../constants';
describe('api/Annotations', function () {
  ...
  describe('updateAnnotation()', function () {
    ...
    test('should reject with an error code for calls with invalid permissions', function () {
      var errorCallback = jest.fn();
      var successCallback = jest.fn();
      annotations.updateAnnotation('12345', '67890', {
        can_edit: false
      }, message, successCallback, errorCallback);
