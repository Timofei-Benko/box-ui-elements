...
describe('api/Folder', function () {
  ...
  describe('getUrl()', function () {
    ...
    test('should return correct folder api url with id', function () {
  ...
  describe('getFolder()', function () {
    ...
    test('should save args and make folder request when not cached', function () {
      folder.folderRequest = jest.fn();
    ...
    test('should save args and not make folder request when cached', function () {
      folder.folderRequest = jest.fn();
    ...
    test('should save args and make folder request when cached but forced to fetch', function () {
      var unsetMock = jest.fn();
      folder.folderRequest = jest.fn();
      folder.getCache = jest.fn().mockReturnValueOnce({
        unset: unsetMock
      });
      folder.getCacheKey = jest.fn().mockReturnValueOnce('key');
      folder.isLoaded = jest.fn().mockReturnValueOnce(false);
  ...
  describe('folderRequest()', function () {
    ...
    test('should make xhr to folder and call success callback', function () {
      ...
      return folder.folderRequest().then(function () {
    ...
    test('should make xhr to folder and call error callback', function () {
  ...
  describe('folderSuccessHandler()', function () {
    beforeEach(function () {
      item1 = {
        id: 'item1',
        name: 'item1',
    ...
    test('should throw bad item error when item collection entries is missing', function () {
      folder.finish = jest.fn();
    ...
    test('should throw bad item error when item collection total count is missing', function () {
      folder.finish = jest.fn();
      expect(folder.folderSuccessHandler.bind(folder, {
        item_collection: {
          entries: [],
    ...
    test('should throw bad item error when item collection offset is missing', function () {
      folder.finish = jest.fn();
      expect(folder.folderSuccessHandler.bind(folder, {
        item_collection: {
          entries: [],
    ...
    test('should throw bad item error when item collection limit is missing', function () {
      folder.finish = jest.fn();
      expect(folder.folderSuccessHandler.bind(folder, {
        item_collection: {
          entries: [],
  ...
  describe('finish()', function () {
    ...
    test('should call success callback with 100% percent loaded when item collection is loaded', function () {
      folder.id = 'id';
      folder.key = 'key';
      folder.sortBy = 'name';
      folder.sortDirection = 'ASC';
    ...
    test('should call success callback with 100% percent loaded when item collection total count is 0', function () {
      folder.id = 'id';
      folder.key = 'key';
      folder.sortBy = 'name';
      folder.sortDirection = 'ASC';
    ...
    test('should throw bad item error when path collection is missing', function () {
      cache.set('key', {
        item_collection: 'foo'
      });
      folder.id = 'id';
    ...
    test('should throw bad item error when item collection is missing total_count', function () {
      cache.set('key', {
        path_collection: 'foo',
        item_collection: {
          entries: []
  ...
  describe('create()', function () {
    ...
    test('should save args and make folder create request when not cached', function () {
      folder.folderCreateRequest = jest.fn();
      folder.getCacheKey = jest.fn().mockReturnValueOnce('key');
      folder.create('id', 'name', 'success', 'fail');
      expect(folder.getCacheKey).toHaveBeenCalledWith('id');
  ...
  describe('folderCreateRequest()', function () {
    beforeEach(function () {
      folder.id = 'id';
      folder.successCallback = 'success';
      folder.errorCallback = 'fail';
    ...
    test('should make xhr to folder create and call success callback', function () {
      folder.createSuccessHandler = jest.fn();
      folder.errorHandler = jest.fn();
      folder.xhr = {
        post: jest.fn().mockReturnValueOnce(Promise.resolve('success'))
      };
      return folder.folderCreateRequest('foo').then(function () {
        expect(folder.createSuccessHandler).toHaveBeenCalledWith('success');
        expect(folder.errorHandler).not.toHaveBeenCalled();
        expect(folder.xhr.post).toHaveBeenCalledWith({
          url: "https://api.box.com/2.0/folders?fields=".concat(FOLDER_FIELDS_TO_FETCH.toString()),
          data: {
            name: 'foo',
            parent: {
              id: 'id'
  ...
  describe('createSuccessHandler()', function () {
    beforeEach(function () {
      item1 = {
        id: 'item1',
        name: 'item1',
    ...
    test('should not do anything if new child folder doesnt have an id', function () {
    ...
    test('should insert the response item inside the parent folder', function () {
      folder.id = 'id';
      folder.key = 'key';
      folder.successCallback = jest.fn();
      folder.getCache = jest.fn().mockReturnValueOnce(cache);
