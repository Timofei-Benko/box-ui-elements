...
function (_MarkerBasedApi) {
  _inherits(MarkerBasedUsers, _MarkerBasedApi);

  function MarkerBasedUsers() {
    _classCallCheck(this, MarkerBasedUsers);

    return _possibleConstructorReturn(this, _getPrototypeOf(MarkerBasedUsers).apply(this, arguments));
  }

  _createClass(MarkerBasedUsers, [{
    key: "getUrl",
    ...
    value: function getUrl() {
      return "".concat(this.getBaseApiUrl(), "/users");
    }
    /**
    ...
    key: "getUsersInEnterprise",
    value: function getUsersInEnterprise(id, successCallback, errorCallback, requestData) {
