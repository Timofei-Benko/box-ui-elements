...
describe('components/select-button/SelectButton', function () {
  test.each([['components-selectbutton--regular'], ['components-selectbutton--disabled'], ['components-selectbutton--with-error']])('looks visually correct when using story %s',
  /*#__PURE__*/
  function () {
