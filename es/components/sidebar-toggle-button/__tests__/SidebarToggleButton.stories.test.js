...
describe('components/sidebar-toggle-button/SidebarToggleButton', function () {
  test.each(['components-sidebartogglebutton--open', 'components-sidebartogglebutton--closed', 'components-sidebartogglebutton--left-facing'])('looks visually correct when using story %s',
  /*#__PURE__*/
  function () {
