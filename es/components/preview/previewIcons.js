...
var register = function register(icon, color, extensions) {
...
register(IconFileAudio, vars.bdlPurpleRain, ['aac', 'aif', 'aifc', 'aiff', 'amr', 'au', 'flac', 'm4a', 'mp3', 'ra', 'wav', 'wma']);
register(IconFileBoxNote, vars.bdlGray20, ['boxnote']);
register(IconFileCode, '#E33D55', ['as', 'as3', 'asm', 'bat', 'c', 'cc', 'cmake', 'cpp', 'cs', 'css', 'cxx', 'diff', 'erb', 'groovy', 'h', 'haml', 'hh', 'htm', 'html', 'java', 'js', 'json', 'less', 'm', 'make', 'md', 'ml', 'mm', 'php', 'pl', 'plist', 'properties', 'py', 'rb', 'rst', 'sass', 'scala', 'script', 'scm', 'sml', 'sql', 'sh', 'vi', 'vim', 'xhtml', 'xml', 'xsd', 'xsl', 'yaml']);
...
register(IconFileImage, '#3FB87F', ['bmp', 'cr2', 'crw', 'dcm', 'dng', 'gif', 'heic', 'jpeg', 'jpg', 'nef', 'png', 'ps', 'raf', 'raw', 'svg', 'swf', 'tga', 'tif', 'tiff']);
