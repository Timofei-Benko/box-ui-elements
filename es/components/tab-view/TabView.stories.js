...
export var basic = function basic() {
  return React.createElement(TabView, {
    ...
    title: "Item 1"
  }, "Bonbon sweet jujubes chocolate cake cupcake brownie ice cream apple pie. Sesame snaps chocolate bar pie halvah jujubes candy muffin cake souffl\xE9. Tart drag\xE9e bear claw cookie. Sweet roll muffin jelly-o."), React.createElement(Tab, {
    title: "Item 2"
...
export var withCallback = function withCallback() {
  // eslint-disable-next-line no-alert
  var cb = function cb(selectedIndex) {
    return alert(selectedIndex);
  };
  ...
  return React.createElement(TabView, {
    ...
    title: "Item 1"
  }, "Jujubes pie apple pie pie caramels gummies sesame snaps sweet roll chocolate bar. Powder macaroon halvah oat cake. Icing lollipop cookie. Cookie chocolate bar sweet roll danish chocolate jujubes cake halvah ice cream.", ' '), React.createElement(Tab, {
    title: "Item 2"
...
export var dynamicWithLinks = function dynamicWithLinks() {
  return React.createElement(TabView, {
    defaultSelectedIndex: 0,
    isDynamic: true
  }, React.createElement(Tab, {
