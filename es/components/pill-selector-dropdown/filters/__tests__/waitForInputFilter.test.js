...
describe('components/pill-selector-dropdown/filters/waitForInputFilter', function () {
  var options = [{
    displayText: 'value1',
    value: 'value1'
  }, {
  ...
  test('should return empty array when input is empty and selected options are provided', function () {
