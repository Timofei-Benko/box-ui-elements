...
describe('components/modal/Modal', function () {
  var MODAL_STORIES = ['components-modal--basic', 'components-modal--with-custom-backdrop-click-handler'];
  test.each(MODAL_STORIES)('looks visually correct when using story %s',
  /*#__PURE__*/
  function () {
  ...
  test.each(MODAL_STORIES)('looks visually correct when button is clicked in story %s',
  /*#__PURE__*/
  function () {
