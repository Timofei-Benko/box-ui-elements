  ...
  function ActivitySidebar(props) {
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(userId) {
        var _this$props12, file, api;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props12 = _this.props, file = _this$props12.file, api = _this$props12.api;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleAnnotationSelect", function (annotation) {
      ...
      var _this$props13 = _this.props,
          emitAnnotatorActiveChangeEvent = _this$props13.emitAnnotatorActiveChangeEvent,
          file = _this$props13.file,
          getAnnotationsMatchPath = _this$props13.getAnnotationsMatchPath,
          getAnnotationsPath = _this$props13.getAnnotationsPath,
          history = _this$props13.history,
          location = _this$props13.location,
          onAnnotationSelect = _this$props13.onAnnotationSelect;
  ...
  _createClass(ActivitySidebar, [{
    ...
    value: function fetchFeedItems() {
      ...
      var _this$props15 = this.props,
          ...
          features = _this$props15.features;
    ...
    value: function render() {
      var _this$props17 = this.props,
          elementId = _this$props17.elementId,
          file = _this$props17.file,
          _this$props17$isDisab = _this$props17.isDisabled,
          isDisabled = _this$props17$isDisab === void 0 ? false : _this$props17$isDisab,
          onVersionHistoryClick = _this$props17.onVersionHistoryClick,
          getUserProfileUrl = _this$props17.getUserProfileUrl,
          activeFeedEntryId = _this$props17.activeFeedEntryId,
          activeFeedEntryType = _this$props17.activeFeedEntryType,
          onTaskView = _this$props17.onTaskView;
