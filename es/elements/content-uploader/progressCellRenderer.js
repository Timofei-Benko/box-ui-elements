 ...
 */
var getErrorMessage = function getErrorMessage(errorCode, itemName, shouldShowUpgradeCTAMessage) {
  switch (errorCode) {
    ...
    case ERROR_CODE_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED:
      if (shouldShowUpgradeCTAMessage) {
        return React.createElement(FormattedMessage, messages.uploadsFileSizeLimitExceededErrorMessageForUpgradeCta);
      }
...
export default (function (shouldShowUpgradeCTAMessage) {
