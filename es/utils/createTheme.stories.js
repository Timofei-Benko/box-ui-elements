...
})(["display:inline-block;background:", ";border:1px solid ", ";height:1em;width:1em;border-radius:", ";"], function (p) {
  return p.color;
}, vars.bdlGray30, vars.bdlBorderRadiusSize);
var BaseButton = styled(BoxButton).withConfig({
  displayName: "createThemestories__BaseButton",
  componentId: "wave58-1"
})(["background:", ";border-color:", ";color:", ";font-weight:bold;border-radius:", ";font-size:", ";.btn:not(.is-disabled)&:hover{background:", ";border-color:", ";}.btn:not(.is-disabled)&:active{background:", ";border-color:", ";}"], function (props) {
  return props.theme.base.buttonBackground;
}, function (props) {
  return props.theme.base.buttonBorder;
}, function (props) {
  return props.theme.base.buttonForeground;
}, vars.bdlBorderRadiusSizeMed, vars.bdlFontSizeDejaBlue, function (props) {
...
})(["width:200px;min-height:500px;padding:8px;border-radius:", ";display:flex;flex-direction:column;color:", ";border:1px solid ", ";background:", ";"], vars.bdlBorderRadiusSize, function (p) {
...
})(["cursor:pointer;padding:8px 12px;margin:2px 4px;border-radius:", ";font-weight:bold;transition:0.15s;border:1px solid;border-color:transparent;&:hover{background:", ";}&.active,&:active{background:", ";}&:focus,&:active{border-color:", ";}&.alt{background:", ";&:hover{background:", ";}}"], vars.bdlBorderRadiusSizeLarge, function (p) {
