...
function parseEmails(text) {
  ...
  var emails = text.match(/[^\s[<(]+@[^\s<>@,/\\]+\.[^\s<>,;)]+/gi);
...
export var checkIsExternalUser = function checkIsExternalUser(isCurrentUserOwner, ownerEmailDomain, emailToCheck) {
